...
import 'package:taskmana/common/models/task_model.dart';
...
class DbHelper {
  static Future<void> createTables(sql.Database database)async {
    await database.execute(
      ...
      "title STRINIG, desc TEXT, date STRING, "
  ...
  static Future<sql.Database> db() async{
    return sql.openDatabase('jainil', version: 1,
  ...
  static Future<int> createUser(Task isVerified) async {
    final db = await DbHelper.db();
